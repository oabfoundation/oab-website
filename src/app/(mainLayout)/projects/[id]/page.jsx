...
const projectData = [
  {
    ...
    description: "Providing books, school materials, and scholarships to underprivileged students across Bangladesh.",
  ...
  },
  {
    id: 3,
    title: "Medical Aid",
    description: "Supporting patients with medical expenses and organizing free health camps.",
  ...
  },
  {
    ...
    description: "Distributing warm clothes to protect vulnerable communities during winter.",
  ...
  },
  {
    ...
    description: "Training youth with practical skills to help them become financially independent.",
  ...
  },
  {
    ...
    description: "Supporting women through education, microfinance, and entrepreneurship training.",
    ...
    <main className="min-h-screen pt-20">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          ...
          />
          <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl">
            <div className="text-orange-600"><Calendar size={20} /></div>
            <div>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-8 p-3 bg-orange-50 rounded-2xl border border-orange-100">
              <h3 className="text-xl font-semibold text-orange-800 mb-4">Our Impact</h3>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-3xl font-bold text-orange-600">{project.beneficiaries.toLocaleString()}+</p>
            ...
            <div className="bg-white rounded-2xl p-3 mt-4 border border-gray-100">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Want to Learn More?</h3>
              <p className="text-gray-600 text-sm mb-4">
                Contact our program coordinator for detailed information about this project.
              </p>
              <Link
                href="/contact"
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Support This Project</h3>
              <p className="text-gray-600 mb-6">
                Your contribution helps us expand our reach and create lasting change.
              </p>
              <button className="w-full bg-orange-600 text-white py-3 px-4 rounded-xl hover:bg-orange-700 transition-colors font-semibold mb-3">
                Donate Now
              </button>
