...
export default function CommitteeForm() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        Swal.fire({
          title: "Success!",
          text: `Committee member ${isEdit} successfully.`,
          icon: "success",
  ...
  const handleDelete = async (id, name) => {
    ...
    if (confirm.isConfirmed) {
      setDeleting(id);
      try {
        const response = await fetch(`/api/committee/${id}`, {
          method: "DELETE",
        });
    ...
    <div className="mx-auto p-8 font-sans">
      ...
      <div className="max-w-6xl mx-auto p-8 bg-white shadow-xl rounded-3xl border border-gray-100">
        ...
        {fetchingMembers ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500">No committee members yet. Add one to get started!</p>
          </div>
        ) : (
