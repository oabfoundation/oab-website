  ...
  return (
    <div className="relative py-16 overflow-hidden">
      <div className="relative " ref={containerRef}>
        <BottomToTop>
          ...
          <div className="max-w-3xl mx-auto text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
              Numbers That{" "}
              <span className="text-orange-600">Speak Volumes</span>
            </h2>
            <div className="h-1.5 w-20 bg-orange-500 mx-auto mt-4 rounded-full"></div>
            <p className="mt-6 text-lg text-gray-600 leading-relaxed">
              Every digit represents a milestone in our journey—a testament to
              our
        ...
        <BottomToTop>
          {/* Main Stats Grid */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 pt-2">
