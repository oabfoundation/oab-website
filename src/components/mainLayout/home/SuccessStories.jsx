...
export default function SuccessStories() {
  return (
    <div className="max-w-7xl mx-auto py-16">
      ...
      <BottomToTop>
        {/* Story Cards */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 pb-2">
          {stories.map((story, index) => (
            <div
              key={index}
              className="bg-gray-50 rounded-2xl border border-transparent hover:border-orange-500 transition duration-300 overflow-hidden flex flex-col"
            >
