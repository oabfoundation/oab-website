...
import { MapPin, Users, Building, Globe, ChevronRight, Award, Target } from "lucide-react";
...
export default function WeCoverBangladesh() {
  ...
  const districts = [
    { name: "Dhaka", programs: 25, beneficiaries: "500K+", color: "bg-orange-500" },
    { name: "Chittagong", programs: 18, beneficiaries: "350K+", color: "bg-orange-500" },
    { name: "Rajshahi", programs: 15, beneficiaries: "280K+", color: "bg-orange-500" },
    { name: "Khulna", programs: 12, beneficiaries: "220K+", color: "bg-orange-500" },
    { name: "Sylhet", programs: 10, beneficiaries: "180K+", color: "bg-orange-500" },
    { name: "Barisal", programs: 8, beneficiaries: "150K+", color: "bg-orange-500" },
    { name: "Rangpur", programs: 14, beneficiaries: "260K+", color: "bg-orange-500" },
    { name: "Mymensingh", programs: 11, beneficiaries: "200K+", color: "bg-orange-500" },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="font-bold text-5xl md:text-6xl text-gray-900 mb-4">
            We Cover{" "}
            <span className="bg-gradient-to-r from-[#ff5a00] to-[#ff8c52] bg-clip-text text-transparent">
              Bangladesh
            </span>
          </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          <div className="bg-white rounded-xl p-6  transition-all duration-300 text-center group hover:scale-105">
            ...
            <div className="text-3xl font-bold text-gray-900">{stats.totalDistricts}</div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 text-center group hover:scale-105">
            ...
            <div className="text-3xl font-bold text-gray-900">{stats.beneficiaries}</div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="p-4 bg-gradient-to-r from-gray-50 to-white border-b border-gray-100">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-semibold text-gray-700">Interactive Coverage Map</h3>
                  </div>
                ...
                {hoveredDistrict && (
                  <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-lg shadow-lg border border-orange-200">
                    <p className="text-sm font-medium text-gray-700">
                      Hovering: <span className="text-orange-600">{hoveredDistrict}</span>
                    </p>
                  </div>
                )}
              </div>
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl  p-6 ">
              ...
              {selectedDistrict ? (
                ...
                <p className="text-gray-500 text-sm">
                  Click on any district on the map to see detailed information about our programs and impact.
                </p>
              )}
            </div>
            ...
            {/* District List */}
            <div className="bg-white rounded-2xl p-6">
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Key Districts</h3>
                ...
                {districts.map((district, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className={`w-2 h-2 ${district.color} rounded-full`}></div>
                      <span className="font-medium text-gray-700 group-hover:text-orange-600 transition-colors">
                        {district.name}
                      </span>
                    </div>
                    <span className="text-sm text-gray-500">{district.programs} programs</span>
                  </div>
                ))}
              </div>
            </div>
