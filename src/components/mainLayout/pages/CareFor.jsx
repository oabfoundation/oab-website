...
export default function WhatWeCareFor() {
  ...
  const careItems = [
    ...
    },
    {
      ...
      icon: Recycle,
      description: "Plastic pollution is one of the most pressing environmental threats we face today. At OAB Foundation, we are committed to reducing plastic waste and protecting our environment for future generations.We organize clean-up drives, awareness campaigns, and educational programs to help communities understand the dangers of single-use plastics.By promoting eco-friendly alternatives and sustainable habits, we encourage people to reduce, reuse, and rethink plastic use in daily life. Together, we’re working toward a cleaner, greener, and plastic-free Bangladesh.",
      image: "https://oabfoundation.org/wp-content/uploads/2025/07/5cf06c68-7b2d-4431-a81a-d05e11586b87.jpeg",
      stats: "50+ Clean-up Drives",

      reverse: true,
      achievements: ["Plastic-Free Zones", "Recycling Programs", "Eco Alternatives"]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto mt-4">
            Committed to creating sustainable change through environmental protection, 
